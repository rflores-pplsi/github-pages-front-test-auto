...
let btnMarketSelect: string = '#openDropdownRightButtonId';
let ddUnitedStateEnglishOption: string = 'a[onclick*=en-US]';
let ddUnitedStateSpanishOption: string = 'a[onclick*=es-US]';
let ddCanadaEnglishOption: string = 'a[onclick*=en-CA]';
let ddCanadaFrenchOption: string = 'a[onclick*=fr-CA]';
...
export class LoginHeaderPage extends LoginPage {
  ...
  // Change market to English - Unisted States
  ...
  // Change market to Spanish - Unisted States
  ...
  // Market Selection button should have text Unisted States - English 
