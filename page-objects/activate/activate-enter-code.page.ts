...
// ========================== Selectors ========================== 
let stpEnterCode : string = '//div[contains(@class, "step-container") and contains(.,"Enter Code")]//div[contains(@class,"step-circle--current")]';
let txtAccountCode : string = '[placeholder="123456"]';
let btnCreateAccount : string = 'button:has-text("Create Account")';
let lnkDontKnowCode : string = 'a:has-text("know your code?")';
let lnkSignInAsAnotherUser : string = 'a:has-text("Sign in as another user")';
let msgSuccess : string = 'span:has-text("Success, an email has been sent to your email address.")';
