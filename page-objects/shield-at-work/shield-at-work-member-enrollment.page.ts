...
const btnEnrollNewMember =
  ".lsux-content  div:nth-child(3) .lsux-button--tertiary > span";
...
export class ShieldAtWorkMemberEnrollment extends LsWorkLoginPage {
  ...
  navigateToShieldAtWorkMemberEnrollment = async (): Promise<void> => {
    console.log(
      " - accountShieldAtWorkPage.navigateToShieldAtWorkMemberEnrollment"
    );
    // Navigate to Url
  ...
  clickEnrollNewMember = async (): Promise<void> => {
    ...
    console.log(
      " - navigateToShieldAtWorkMemberEnrollement.clickEnrollNewMember"
    );
  ...
  clickContinueButtonContactInfo = async (): Promise<void> => {
    ...
    console.log(
      " - navigateToShieldAtWorkMemberEnrollement.clickContinueButtonContactInfo"
    );
