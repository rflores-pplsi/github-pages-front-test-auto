...
export class AccountNavigationPage extends LoginPage {
  ...
  assertAccountProfileUrl = async () => {
    ...
    await expect(this.page).toHaveURL(
      UrlsUtils.legalshieldUrls.account.url + "/profile"
    );
  ...
  assertAccountPaymentsUrl = async () => {
    ...
    await expect(this.page).toHaveURL(
      UrlsUtils.legalshieldUrls.account.url + "/payments"
    );
    // Wait for document to load before subsequent steps
    await this.page.waitForLoadState("domcontentloaded");
  };
  ...
  assertAccountSecurityUrl = async () => {
    ...
    await expect(this.page).toHaveURL(
      UrlsUtils.legalshieldUrls.account.url + "/security"
    );
    // Wait for document to load before subsequent steps
    await this.page.waitForLoadState("domcontentloaded");
  };
  ...
  assertAccountResourcesUrl = async () => {
    ...
    await expect(this.page).toHaveURL(
      UrlsUtils.legalshieldUrls.account.url + "/resources"
    );
    // Wait for document to load before subsequent steps
    await this.page.waitForLoadState("domcontentloaded");
  };
  ...
  assertAccountPreferencesUrl = async () => {
    ...
    await expect(this.page).toHaveURL(
      UrlsUtils.legalshieldUrls.account.url + "/preferences"
    );
    // Wait for document to load before subsequent steps
    await this.page.waitForLoadState("domcontentloaded");
  };
  ...
  assertAccountPlansUrl = async () => {
    ...
    await expect(this.page).toHaveURL(
      UrlsUtils.legalshieldUrls.account.url + "/plans"
    );
    // Wait for document to load before subsequent steps
    await this.page.waitForLoadState("domcontentloaded");
  };
