...
// ========================== Selectors ==================================
const imgFormsLogoLarge: string =
  '//img[contains(@alt,"Legalshield Forms logo large")]';
const lblForms: string = '//h5[contains(text(),"Forms")]';
const btnFormsGoToWebsite: string =
  '//div[contains(@class,"resources--forms-ls")]//button';
const imgMemberPerksLogoLarge: string =
  '//img[contains(@alt,"Member Perks logo large")]';
const lblMemberPerks: string = '//h5[contains(text(),"Member Perks")]';
const btnMemberPerksGoToWebsite: string =
  '//div[contains(@class,"resources--member-perks")]//button';
