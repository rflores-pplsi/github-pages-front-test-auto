...
import { ProfilePickerPage } from '../../page-objects/associate/associate-office-profile-picker.page';
...
test('LEGACY tier level associate logs in with valid username and password', async ({ page }) => {
...
test('ADVANTAGE PLUS tier level associate logs in with valid username and password', async ({ page }) => {
