...
export default class RegionsUtils {
  ...
  constructor(page: Page, baseURL: string) {
    ...
    this.ele_sddFooterProvince = page.locator(
      "#lsc_footer_region_selector_default .lsc_region_selector"
    );
    this.ele_sopFooterSelectedProvince = page.locator(
      "#lsc_footer_region_selector_default .lsc_region_selector option:checked"
    );
  }
