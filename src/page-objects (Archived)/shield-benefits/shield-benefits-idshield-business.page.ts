...
const BNT_ENROLL = 'a:has-text("Enroll Now")';
...
const TAB_IDSHIELD_BUSINESS_PAGE = '#root > div > nav > div > div > ul > li:nth-child(5) > a';
...
export class ShieldBenefitsIDShieldBusinessPage extends OktaPage {
  ...
  clickBtnEnroll = async (): Promise<void> => {
    ...
    await this.clickOnElement(BNT_ENROLL);
  };
  ...
  clickBtnIDShieldBusinessPage = async (): Promise<void> => {
    ...
    await this.clickOnElement(TAB_IDSHIELD_BUSINESS_PAGE);
  };
  ...
  assertShieldBenefitsIDShieldBusinessPage = async (): Promise<void> => {
    ...
    await this.assertElementIsVisible(TAB_IDSHIELD_BUSINESS_PAGE);
  };
  ...
  assertEnrollNowButtonIsDisplayed = async (): Promise<void> => {
    ...
    await this.assertElementIsVisible(BNT_ENROLL);
  };
