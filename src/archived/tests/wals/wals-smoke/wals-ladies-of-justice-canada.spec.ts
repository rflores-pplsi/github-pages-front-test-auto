  ...
  test('Search Profiles of Success by Name and displays at least one', async () => {
    ...
    test('When I click on the Executive Team Link am redirected to the the executive team page', async () => {
      ...
      await test.step('Assert executive team url', async () => {
        await walsAssociateSearchPage.WeAreLegalShieldAssertUrlContains(UrlsUtils.wals.urls.urlLadiesCa + '/executive-team');
      });
    });
    ...
    test('When I click on the About Us Link am redirected to the the about us page', async () => {
      ...
      await test.step('Assert about us url', async () => {
        await walsAssociateSearchPage.WeAreLegalShieldAssertUrlContains(UrlsUtils.wals.urls.urlLadiesCa + '/about');
      });
    });
    ...
    test('When I click on the Profiles of Success Link am redirected to the the opportunity success page', async () => {
      ...
      await test.step('Assert opportunity success url', async () => {
        await walsAssociateSearchPage.WeAreLegalShieldAssertUrlContains(UrlsUtils.wals.urls.urlLadiesCa + '/opportunity/success');
      });
    });

    test('When I click on the Ladies of Justice logo I am returned to ladiesofjustice.ca', async () => {
      await test.step('Navigate away from ladiesofjustice.ca', async () => {
        await weAreLegalShieldHeaderComponent.weAreLegalShieldHeaderLocExecutiveTeamLink.click();
      });
      ...
      await test.step('Assert ladiesofjustice.ca url', async () => {
        await walsAssociateSearchPage.WeAreLegalShieldAssertUrlContains(UrlsUtils.wals.urls.urlLadiesCa);
      });
    });
  });
});
