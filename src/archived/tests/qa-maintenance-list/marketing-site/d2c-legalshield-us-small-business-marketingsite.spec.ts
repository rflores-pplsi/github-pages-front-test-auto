...
import { LegalShieldUSPage } from '../../../../archived/page-objects-oldest/qa-maintenance-list/d2c-legalshield-us-marketingsite.page';
...
test('D2C LegalShield US marketing small business plan', async () => {
  ...
  await test.step('Pick annual plan', async () => {
    await legalShieldUSPage.pickAPlan('SMALL_BUSINESS');
  });
