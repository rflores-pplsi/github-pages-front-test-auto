...
import { LegalShieldCAPage } from '../../../../archived/page-objects-oldest/qa-maintenance-list/d2c-legalshield-ca-marketingsite.page';
import { D2CLegalShieldCaPage } from '../../../../archived/page-objects-oldest/qa-maintenance-list/d2c-legalshield-ca.page';
...
test('D2E LegalShield CA marketing individual and family plan', async () => {
  ...
  await test.step('Pick a monthly plan', async () => {
    await legalShieldCAPage.pickAPlan('INDIVIDUAL_FAMILY');
  });
