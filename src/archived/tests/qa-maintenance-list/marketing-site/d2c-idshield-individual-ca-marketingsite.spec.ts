...
import { IDShieldCAPage } from '../../../../archived/page-objects-oldest/qa-maintenance-list/d2c-idshield-ca-marketingsite.page';
...
test('D2E idShield CA marketing individual plan', async () => {
  test.slow();
