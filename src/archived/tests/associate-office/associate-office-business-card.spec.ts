...
import { BusinessCard } from '../../../archived/page-objects-old/associate-office/associate-office-business-card.page';
...
test('The Business Card page has the correct URL', async () => {
  await businessCard.assertPageHasCorrectURL();
});

test('The Business Card page has the correct title', async () => {
  await businessCard.assertPageHasCorrectTitle();
});

test('The Business Card page has the correct navigation', async () => {
  await businessCard.assertNavMenuOnPage();
});

test('The Business Card page has the correct header', async () => {
  await businessCard.assertPageHasCorrectHeader();
});

test('Verify that the Profile information message is displaying', async () => {
  await businessCard.assertProfileInfoMsg();
});

test('Verify that the Marketing Site Card URL is displaying', async () => {
...
test('Verify that the First Name, Last Name, Email, Phone Number and Checkbox are displaying', async () => {
...
test('Verify that the Component to Upload Photo is displaying', async () => {
...
test('Verify that the Plan selection message is displaying', async () => {
  await businessCard.assertPlanSelection();
});

test('Verify that the LegalShield Plan is displaying', async () => {
...
test('Verify that the IDShield Plan is displaying', async () => {
...
test('Verify that the Small Business Plan is displaying', async () => {
...
test('Verify that the Publish button is displaying', async () => {
  await businessCard.assertPublishButton();
});

test('The Business Card page has correct footer', async () => {
