...
import { NavMenuPage } from '../../../archived/page-objects-old/associate-office/associate-office-header-footer-nav-menu.page';
...
test('Associate Office is displayed in the Header', async () => {
  console.log('Test Case: Associate Office is displayed in the Header');
  await navMenuPage.assertNameAOIsDisplayed();
});

test('Customer Support Information is displayed in the Header', async () => {
...
test('LSAdvantage is displayed in the left Navigation Menu', async () => {
  console.log('Test Case: LSAdvantage is displayed in the left Navigation Menu');
  await navMenuPage.assertLSAdvantageIsDisplayed();
});

test('Associate Perks is displayed in the left Navigation Menu', async () => {
