 ...
 */
export class LoginLocatorsPage {
  // ========================== Instantiate Classes ========================
  // ========================== Selectors ==================================
  readonly context: BrowserContext;
  protected page: Page;
  readonly loginLocTxtEmailOrUsername: Locator;
  readonly loginLocTxtPassword: Locator;
  readonly loginLocBtnSignIn: Locator;
  readonly loginLocLnkSignUp: Locator;
  readonly loginLocLnkSignIn: Locator;
  readonly loginLocLnkForgotPassword: Locator;
  readonly loginLocLnkForgotEmailOrUsername: Locator;
  readonly loginLocBtnOk: Locator;
  /**
  ...
  constructor(context: BrowserContext, page: Page) {
    ...
    this.loginLocLnkForgotEmailOrUsername = page.locator('a:has-text("Forgot Email/Username?")');
    this.loginLocBtnOk = page.locator('//span[contains(text(),"OK")]');
  }
  /**
   * @param {string} url
   * @memberof BasePage
