...
test('Navigate to the Profile Name page by clicking the Name Edit button @smoke @visual', async ({ page }) => {
...
test('Navigate to the Profile Address page by clicking the Address Edit button @smoke @visual', async ({ page }) => {
