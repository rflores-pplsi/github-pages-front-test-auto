...
test('User can play the Our Culture video on the Business Solutions Orientation Our Culture Page ', async () => {
...
test('User can pause the Our Culture video on the Business Solutions Orientation Our Culture Page ', async () => {
  await test.step('Click on Our Culture Video play button', async () => {
    await pplsiBusinessSolutionsOrientationVideoComponent.locVideoPlayerPlayButton.click();
  });
...
test('User can skip ahead and back in the Our Culture video on the Business Solutions Orientation Our Culture Page', async ({ page }) => {
...
test('User can mute/unmute the Our Culture video on the Business Solutions Orientation Our Culture Page', async ({ page }) => {
...
test('User can turn Closed Captioning on/off for the Our Culture video on the Business Solutions Orientation Our Culture Page', async ({ page }) => {
...
test('User can change the Quality Setting for the Our Culture video on the Business Solutions Orientation Our Culture Page', async ({ page }) => {
...
test('User can change the Speed Setting for the Our Culture video on the Business Solutions Orientation Our Culture Page', async ({ page }) => {
