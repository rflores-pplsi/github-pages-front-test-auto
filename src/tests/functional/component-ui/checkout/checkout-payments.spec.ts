...
test.describe('United States - Massachusetts, Business - Plan', () => {
  ...
  test('Verify a purchase of a SMB ESS Plan can be made in MA with US Bank Draft @CheckoutPaymentPage', async ({ commonCheckoutService }) => {
  ...
  test('Verify a purchase of a SMB ESS Plan can be made in MA with US Credit Card Page @CheckoutPaymentPage', async ({ commonCheckoutService }) => {
