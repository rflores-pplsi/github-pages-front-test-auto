...
test('User is redirected to  Our Culture Page after Clicking Next button on Next Steps Page ', async ({ page, pplsiService }) => {
...
test('User is redirected to Business Solutions Orientation Prospecting Page after Clicking Back button on NextSteps Page', async ({
  page,
  pplsiService,
}) => {
...
test('User can play the Next Steps video on the Business Solutions Orientation Next Steps Page ', async ({ pplsiService }) => {
...
test('User can pause the Next Steps video on the Business Solutions Orientation Next Steps Page ', async ({ pplsiService }) => {
  await test.step('Click on Next Steps Video play button', async () => {
    await pplsiService.businessSolutionsOrientationPage.videoComponent.locVideoPlayerPlayButton.click();
  });
...
test('User can skip ahead and back in the Next Steps video on the Business Solutions Orientation Next Steps Page', async ({ pplsiService }) => {
...
test('User can mute/unmute the Next Steps video on the Business Solutions Orientation Next Steps Page', async ({ pplsiService }) => {
...
test('User can turn Closed Captioning on/off for the Next Steps video on the Business Solutions Orientation Next Steps Page', async ({
  pplsiService,
}) => {
...
test('User can change the Quality Setting for the Next Steps video on the Business Solutions Orientation Next Steps Page', async ({
  pplsiService,
}) => {
  await test.step('Set the Quality to 720p', async () => {
    await pplsiService.businessSolutionsOrientationPage.videoComponent.selectQualitySetting('720p');
  });
  await test.step('Assert Quality is set to 720p', async () => {
    await pplsiService.businessSolutionsOrientationPage.videoComponent.assertQualitySetting('720p');
  });
});

test('User can change the Speed Setting for the Next Steps video on the Business Solutions Orientation Next Steps Page', async ({
  page,
  pplsiService,
}) => {
