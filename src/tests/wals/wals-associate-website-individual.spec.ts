...
test.describe('Somos legalshield', () => {
  ...
  for (const stte of RegionsUtils.usSpanishStates.filter((state) => state.name == 'Nueva York')) {
...
test.describe('Test We are LegalShield', () => {
  ...
  for (const stte of RegionsUtils.usStates.filter((state) => state.name == 'Virginia')) {
    test('User is able to purchase Associate Startup for Individual at $49 instead of $99', async () => {
      test.slow;
      await test.step('Navigate to legalshield marketing site', async () => {
...
test.describe('Test nous sommes legalshield.ca', () => {
  ...
  for (const stte of RegionsUtils.caFrenchProvinces.filter((state) => state.name == 'Nouveau-Brunswick')) {
    test('User is able to purchase Associate Startup for Individual at $49 instead of $99', async () => {
      test.slow;
...
test.describe('Test We Are legalshield.ca', () => {
  ...
  for (const stte of RegionsUtils.caProvinces.filter((state) => state.name == 'Quebec')) {
    test('User is able to purchase Associate Startup for Individual at $49 instead of $99', async () => {
      test.slow;
      await test.step('Navigate to legalshield CA marketing site', async () => {
...
test.describe('Test Ladies of justice US', () => {
  ...
  for (const stte of RegionsUtils.usStates.filter((state) => state.name == 'New York')) {
    test('User is able to purchase Associate Startup for Individual at $49 instead of $99', async () => {
      test.slow;
      await test.step('Navigate to legalshield marketing site', async () => {
...
test.describe('Test Dames de justice ca', () => {
  ...
  for (const stte of RegionsUtils.caFrenchProvinces.filter((state) => state.name == 'Québec')) {
    test('User is able to purchase Associate Startup for Individual at $49 instead of $99', async () => {
      test.slow;
      await test.step('Navigate to legalshield CA marketing site', async () => {
